...
-- ── Students ────────────────────────────────────────────────
INSERT INTO studio.students (id, first_name, last_name, phone_number, pricing_type, price_per_class, currency, timezone, notes, debtor, created_at, updated_at, deleted)
VALUES
    (1, 'Ana',   'García',  '+34600111222', 'PER_CLASS', 30.00, 'EUROS',   'SPAIN',          'Intermediate level',  FALSE, NOW(), NOW(), FALSE),
    (2, 'Ivan',  'Petrov',  '+79001112233', 'PACKAGE',   NULL,  'RUBLES',  'RUSSIA_MOSCOW',  NULL,                  FALSE, NOW(), NOW(), FALSE),
    (3, 'John',  'Smith',   '+12025551234', 'PER_CLASS', 40.00, 'DOLLARS', 'SPAIN',          NULL,                  FALSE, NOW(), NOW(), FALSE),
    (4, 'Deleted','User',   NULL,           'PER_CLASS', 25.00, 'EUROS',   'SPAIN',          NULL,                  FALSE, NOW(), NOW(), TRUE);
...
-- ── Class sessions ──────────────────────────────────────────
INSERT INTO studio.class_sessions (id, student_id, weekly_schedule_id, class_date, start_time, duration_minutes, status, payment_status, price_charged, currency, package_purchase_id, is_one_off, note, created_at, updated_at, deleted)
VALUES
    -- Ana: past paid session
    (1, 1, 1, '2026-03-02', '10:00', 60, 'COMPLETED', 'PAID',   30.00, 'EUROS',   NULL, FALSE, NULL,           NOW(), NOW(), FALSE),
    -- Ana: today's session, unpaid
    (2, 1, 2, '2026-03-12', '10:00', 60, 'SCHEDULED', 'UNPAID', 30.00, 'EUROS',   NULL, FALSE, NULL,           NOW(), NOW(), FALSE),
    -- Ana: future session
    (3, 1, 1, '2026-03-16', '10:00', 60, 'SCHEDULED', 'UNPAID', 30.00, 'EUROS',   NULL, FALSE, NULL,           NOW(), NOW(), FALSE),
    -- John: paid session on March 5
    (4, 3, NULL, '2026-03-05', '14:00', 60, 'COMPLETED', 'PAID', 40.00, 'DOLLARS', NULL, TRUE,  'Extra class',  NOW(), NOW(), FALSE),
    -- John: paid session on March 10
    (5, 3, NULL, '2026-03-10', '14:00', 60, 'COMPLETED', 'PAID', 40.00, 'DOLLARS', NULL, TRUE,  NULL,           NOW(), NOW(), FALSE);
